...
; peepholed 40		POP BX; line no 4 : ; previously pushed value on stack is removed
		...
		MOV BX, [ BP-10 ]
; peepholed 76		PUSH BX; line no 7 : a loaded
; peepholed 75		POP BX
		PUSH BX
		CALL PRINT_DECIMAL_INTEGER
		
		MOV BX, [ BP-12 ]
; peepholed 82		PUSH BX; line no 8 : b loaded
; peepholed 81		POP BX
		PUSH BX
		CALL PRINT_DECIMAL_INTEGER
