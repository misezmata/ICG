...
.CODE
	...
	foo  PROC
		...
		PUSH BX ; line no 3 : a declared
		
		PUSH BX ; line no 5 : b declared
		...
		POP AX
		MOV [BP + -12], AX; line no 6 : b assined
		MOV BX, AX
		PUSH BX
	...
	main  PROC
		...
		PUSH 1
		CALL foo ; function foo called.; line no 12 : 
		MOV BX, DX; line no 12 :  return result in DX.
		PUSH BX
		POP AX
		MOV [BP + -10], AX; line no 12 : a assined
		MOV BX, AX
		PUSH BX
